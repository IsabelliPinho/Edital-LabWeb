...
$sql=("SELECT nome_completo,media FROM aluno where curso = 'comercio' and concorrencia = '[publica]' and deficiencia = 'nenhuma' and bairro <> 'Venânciosi' order by media desc limit 10");
$nsql = ("SELECT nome_completo,media FROM aluno where curso = 'comercio' and concorrencia = '[publica]' and deficiencia = 'nenhuma'  and bairro <> 'Venânciosi' order by media desc limit 5 offset 10");

//Classificados com deficiência 
$query = ("SELECT nome_completo,media from aluno where curso = 'comercio' and deficiencia <> 'nenhuma'  and bairro <> 'Venânciosi' order by media desc limit 2");
$nquery = ("SELECT nome_completo,media from aluno where curso = 'comercio' and deficiencia <> 'nenhuma'  and bairro <> 'Venânciosi' order by media desc limit 5 offset 2");

//Classificados por cota (pública)
$mysqll = ("SELECT nome_completo,media from aluno where curso = 'comercio' and deficiencia = 'nenhuma' and bairro = 'Venânciosi' and concorrencia ='[publica]' order by media desc limit 10");
$nmysqll = ("SELECT nome_completo,media from aluno where curso = 'comercio' and deficiencia = 'nenhuma' and bairro = 'Venânciosi' and concorrencia ='[publica]' order by media desc limit 5 offset 2");

//Classificados ampla concorrência (Privada)
$my = ("SELECT nome_completo,media from aluno where curso = 'comercio' and concorrencia = '[privada]'  order by media desc limit 10");
$nmy = ("SELECT nome_completo,media from aluno where curso = 'comercio' and concorrencia = '[privada]'  order by media desc limit 5 offset 10");

//Classificados por cota (privada)
$busquer = ("SELECT nome_completo,media from aluno where curso = 'comercio' and deficiencia = 'nenhuma' and bairro = 'Venânciosi' and concorrencia ='[privada]' order by media desc limit 10");
$nbusquer = ("SELECT nome_completo,media from aluno where curso = 'comercio' and deficiencia = 'nenhuma' and bairro = 'Venânciosi' and concorrencia ='[privada]' order by media desc limit 5 offset 2");
...
$pdf->ln(); 
$pdf->Cell(180,10,('Curso Técnico em comercio'),0,0,'C');
